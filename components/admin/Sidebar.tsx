...
import { LayoutDashboard, Users, LogOut, Sparkles, Trophy, CheckSquare, UserCircle, TrendingUp, Briefcase } from 'lucide-react'
...
const nav = [
  ...
  { href: '/admin/commercial', label: 'Comercial', icon: TrendingUp },
  { href: '/admin/cs', label: 'Operacional', icon: Briefcase },
]
