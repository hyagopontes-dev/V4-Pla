...
import { LayoutDashboard, Users, LogOut, Sparkles, Trophy, CheckSquare, UserCircle, TrendingUp, HeartPulse } from 'lucide-react'
...
const nav = [
  ...
  { href: '/admin/cs', label: 'CS', icon: HeartPulse },
]
